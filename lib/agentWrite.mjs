...
const ENUMS = {
  ...
  "job_leads.status": ["new", "evaluating", "proposed", "accepted", "held", "offered", "rejected", "expired", "converted"],
  "job_leads.source": ["manual", "email", "whatsapp", "telegram"],
  "job_leads.job_type": ["full", "direct", "broker_delivery"],
