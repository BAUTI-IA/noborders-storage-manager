 ...
 */
export async function createLeadFromText({ text, source = "manual", sourceRef = null, createdBy = null, sender = null }) {
  need();
...
export async function ingestEmail({ from, subject, text, messageId }) {
  ...
  const lead = await createLeadFromText({ text: body, source: "email", sourceRef: messageId || null, sender });
